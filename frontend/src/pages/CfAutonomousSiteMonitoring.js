...
/**
 * Gap/CFS Feature Page: Autonomous site monitoring
 * Slug: autonomous-site-monitoring
 * Backend: /api/cf-autonomous-site-monitoring
 */
export default function AutonomousSiteMonitoringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-autonomous-site-monitoring', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Autonomous site monitoring</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Drone/camera feeds analyzed for safety violations, equipment placement, work progress.</p>
