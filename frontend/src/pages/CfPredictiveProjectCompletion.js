...
/**
 * Gap/CFS Feature Page: Predictive project completion
 * Slug: predictive-project-completion
 * Backend: /api/cf-predictive-project-completion
 */
export default function PredictiveProjectCompletionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-project-completion', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive project completion</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>ML model forecasts final project cost/schedule based on burn rate, change order patterns.</p>
