...
/**
 * Gap/CFS Feature Page: No supplier/vendor sourcing workflow.
 * Slug: no-supplier-vendor-sourcing-workflow
 * Backend: /api/gap-no-supplier-vendor-sourcing-workflow
 */
export default function NoSupplierVendorSourcingWorkflowPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-supplier-vendor-sourcing-workflow', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No supplier/vendor sourcing workflow.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No supplier/vendor sourcing workflow.</p>
