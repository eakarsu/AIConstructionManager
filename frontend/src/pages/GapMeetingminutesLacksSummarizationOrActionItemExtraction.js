...
/**
 * Gap/CFS Feature Page: `meetingMinutes` lacks summarization or action-item extraction.
 * Slug: meetingminutes-lacks-summarization-or-action-item-extraction
 * Backend: /api/gap-meetingminutes-lacks-summarization-or-action-item-extraction
 */
export default function MeetingminutesLacksSummarizationOrActionItemExtractionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-meetingminutes-lacks-summarization-or-action-item-extraction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>`meetingMinutes` lacks summarization or action-item extraction.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>`meetingMinutes` lacks summarization or action-item extraction.</p>
