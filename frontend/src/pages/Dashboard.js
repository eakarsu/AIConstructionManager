  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.statsRow}>
        <div style={styles.stat('#3b82f6')}>
          <div style={styles.statValue('#3b82f6')}>{features.length}</div>
          <div style={styles.statLabel}>Total Modules</div>
        </div>
        <div style={styles.stat('#10b981')}>
          <div style={styles.statValue('#10b981')}>{totalItems}</div>
          <div style={styles.statLabel}>Total Records</div>
        </div>
        <div style={styles.stat('#8b5cf6')}>
          <div style={styles.statValue('#8b5cf6')}>{aiFeatures}</div>
          <div style={styles.statLabel}>AI-Powered Features</div>
        </div>
        <div style={styles.stat('#f59e0b')}>
          <div style={styles.statValue('#f59e0b')}>{counts['projects'] || 0}</div>
