...
/**
 * Gap/CFS Feature Page: No third-party Trimble/Procore/Revit integrations.
 * Slug: no-third-party-trimble-procore-revit-integrations
 * Backend: /api/gap-no-third-party-trimble-procore-revit-integrations
 */
export default function NoThirdPartyTrimbleProcoreRevitIntegrationsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-third-party-trimble-procore-revit-integrations', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No third-party Trimble/Procore/Revit integrations.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No third-party Trimble/Procore/Revit integrations.</p>
