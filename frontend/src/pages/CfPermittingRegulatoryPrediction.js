...
/**
 * Gap/CFS Feature Page: Permitting & regulatory prediction
 * Slug: permitting-regulatory-prediction
 * Backend: /api/cf-permitting-regulatory-prediction
 */
export default function PermittingRegulatoryPredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-permitting-regulatory-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Permitting & regulatory prediction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Flag upcoming permit expirations; predict approval likelihood for new RFPs.</p>
