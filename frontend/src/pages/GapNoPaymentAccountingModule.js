...
/**
 * Gap/CFS Feature Page: No payment/accounting module.
 * Slug: no-payment-accounting-module
 * Backend: /api/gap-no-payment-accounting-module
 */
export default function NoPaymentAccountingModulePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-payment-accounting-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No payment/accounting module.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No payment/accounting module.</p>
